...
@section('title', 'Edit Lesson - CourseHub')
    ...
    <div class="row justify-content-center">
        <div class="col-lg-7 col-md-9">
            ...
            <div class="card border-0 shadow-lg rounded-4 overflow-hidden lesson-form-card">
                <div class="card-header bg-gradient-blue text-white p-4 border-0 position-relative">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h4 class="mb-1 fw-bold text-white">Edit Lesson</h4>
                            <p class="mb-0 text-white-50 small">
                                Updating lesson: <strong class="text-warning">{{ $lesson->title }}</strong>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <form action="{{ route('lessons.update', $lesson->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" class="form-control form-control-lg rounded-3 @error('title') is-invalid @enderror"
                                id="title" placeholder="e.g. Introduction to Controllers" value="{{ old('title', $lesson->title) }}" required>
                            @error('title')
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" class="form-control rounded-3" id="description" rows="3"
                                placeholder="Add a brief description for this lesson...">{{ old('description', $lesson->description) }}</textarea>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="url" name="video_url" class="form-control form-control-lg rounded-end-3 border-start-0 @error('video_url') is-invalid @enderror"
                                    id="video_url" placeholder="https://www.youtube.com/watch?v=..." value="{{ old('video_url', $lesson->video_url) }}" required>
                            </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-5 pt-3 border-top">
                            <a href="{{ route('lessons.index', ['course_id' => $lesson->course_id]) }}" class="btn btn-outline-secondary px-4 py-2 rounded-3 fw-semibold">
